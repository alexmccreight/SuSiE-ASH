...
X20 = readRDS("X20")
# data <- generate_data(X = X20, total_heritability = 0.25, sparse_effects = 3, nonsparse_coverage = 0.01, theta_beta_ratio = 2)
# 
# plot(data$theta)
# 
# mod <- susie(X = data$X, y = data$y, L = 10, intercept = F, standardize = F)
```
...
X20 = readRDS("X20")
large_simulation_1L10 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 1.4, L = 10, threshold = 0.95)

large_simulation_2L10 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 3, L = 10, threshold = 0.95)

large_simulation_3L10 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 5, L = 10, threshold = 0.95)

large_simulation_1L20 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 1.4, L = 20, threshold = 0.95)

large_simulation_2L20 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 3, L = 20, threshold = 0.95)

large_simulation_3L20 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 5, L = 20, threshold = 0.95)

large_simulation_1L30 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 1.4, L = 30, threshold = 0.95)

large_simulation_2L30 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 3, L = 30, threshold = 0.95)

large_simulation_3L30 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.01, theta_beta_ratio = 5, L = 30, threshold = 0.95)


save(large_simulation_1L10, file = "large_simulation_1.4to1_L10_0.01nonsparse.RData")
save(large_simulation_1L20, file = "large_simulation_1.4to1_L20_0.01nonsparse.RData")
save(large_simulation_1L30, file = "large_simulation_1.4to1_L30_0.01nonsparse.RData")

save(large_simulation_2L10, file = "large_simulation_3to1_L10_0.01nonsparse.RData")
save(large_simulation_2L20, file = "large_simulation_3to1_L20_0.01nonsparse.RData")
save(large_simulation_2L30, file = "large_simulation_3to1_L30_0.01nonsparse.RData")

save(large_simulation_3L10, file = "large_simulation_5to1_L10_0.01nonsparse.RData")
save(large_simulation_3L20, file = "large_simulation_5to1_L20_0.01nonsparse.RData")
save(large_simulation_3L30, file = "large_simulation_5to1_L30_0.01nonsparse.RData")

large_simulation_4L10 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 1.4, L = 10, threshold = 0.95)

large_simulation_5L10 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 3, L = 10, threshold = 0.95)

large_simulation_6L10 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 5, L = 10, threshold = 0.95)

large_simulation_4L20 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 1.4, L = 20, threshold = 0.95)

large_simulation_5L20 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 3, L = 20, threshold = 0.95)

large_simulation_6L20 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 5, L = 20, threshold = 0.95)

large_simulation_4L30 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 1.4, L = 30, threshold = 0.95)

large_simulation_5L30 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 3, L = 30, threshold = 0.95)

large_simulation_6L30 <- simulate_and_score(num_simulations = 10, X = X20, total_heritability = 0.25, nonsparse_coverage = 0.05, theta_beta_ratio = 5, L = 30, threshold = 0.95)


save(large_simulation_4L10, file = "large_simulation_1.4to1_L10_0.05nonsparse.RData")
save(large_simulation_4L20, file = "large_simulation_1.4to1_L20_0.05nonsparse.RData")
save(large_simulation_4L30, file = "large_simulation_1.4to1_L30_0.05nonsparse.RData")

save(large_simulation_5L10, file = "large_simulation_3to1_L10_0.05nonsparse.RData")
save(large_simulation_5L20, file = "large_simulation_3to1_L20_0.05nonsparse.RData")
save(large_simulation_5L30, file = "large_simulation_3to1_L30_0.05nonsparse.RData")

save(large_simulation_6L10, file = "large_simulation_5to1_L10_0.05nonsparse.RData")
save(large_simulation_6L20, file = "large_simulation_5to1_L20_0.05nonsparse.RData")
save(large_simulation_6L30, file = "large_simulation_5to1_L30_0.05nonsparse.RData")
```

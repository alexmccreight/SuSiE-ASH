...
# Packages
#devtools::load_all('/Users/alexmccreight/Columbia/Research/mr.ash.alpha') # mr.ash.alpha.mccreight
devtools::load_all('/Users/alexmccreight/Columbia/Research/susie.ash')
...
This vignette will showcase how the ash component fails to kick in after the first iteration of SuSiE. Specifically, I will generate an oligogenic data setting, run a single iteration of SuSiE, then run a regression on the residuals, and calculate z-scores. [continue]
...
After the first iteration of SuSiE and then running a univariate regression on the residuals, none of the z-scores surpasses the Bonferroni threshold, however, many variants come close. In fact, there are many oligogenic indices in particular that nearly surpass this very conservative threshold meaning that there should be enough information for the mr.ash component to capture. 
...
# Add a legend in the top right showing these values
legend("topright", 
       legend = c(

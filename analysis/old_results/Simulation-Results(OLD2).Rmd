...
directory <- "/Users/alexmccreight/Columbia/Research/SuSiE-ASH/SuSiE-ASH/simulation/8-26-24-results"
...
for (file_path in files) {
  ...
  parts <- parts <- regmatches(file_name, regexec("numIter(\\d+)_totHeritability([0-9.]+)_sparseEffect(\\d+)_nonsparse([0-9.]+)_ratio([0-9.]+)_L(\\d+)", file_name))
  ...
  plot_title <- paste0("h2 = ", total_heritability,
                       ", Sparse Effects = ", sparse_effect, 
                       ", Nonsparse Coverage = ", nonsparse_coverage,
                       ", \nTheta to Beta Ratio = ", theta_beta_ratio)

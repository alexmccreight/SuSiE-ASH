...
large_simulation4 <- simulate_and_score(num_simulations = 10, n = 10000, p = 500, heritability = 1.00, sparse_coverage = 0.01, nonsparse_coverage = 0.1, L = 10, threshold = 0.9)

print(large_simulation$avg_metrics)
print(large_simulation2$avg_metrics)
print(large_simulation3$avg_metrics)
print(large_simulation4$avg_metrics)
